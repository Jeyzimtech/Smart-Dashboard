  ...
  <nav className="fixed top-0 w-full z-50 bg-[#0d131f]/60 backdrop-blur-xl flex justify-between items-center px-6 h-16 border-b border-outline-variant/10">
    <div className="flex items-center gap-8">
      <div className="flex items-center gap-2">
        ...
        <span className="text-[14px] sm:text-lg font-bold tracking-tighter text-primary font-headline uppercase whitespace-nowrap overflow-hidden text-ellipsis max-w-[180px] xs:max-w-none">IoT Temperature Ops Center</span>
      </div>
